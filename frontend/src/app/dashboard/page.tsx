      ...
      <div className="relative p-8 md:p-12">
        <div className="flex flex-col lg:flex-row items-start justify-between gap-8">
              ...
              <Dialog open={isAddSubjectDialogOpen} onOpenChange={setIsAddSubjectDialogOpen}>
                ...
                <DialogContent className="sm:max-w-[480px]">
                  <DialogHeader>
                    ...
                    <DialogDescription>Zadaj názov a voliteľný popis pre tvoj nový študijný predmet.</DialogDescription>
                  </DialogHeader>
                  <form onSubmit={handleCreateSubject} className="space-y-4 pt-2">
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        required
                        placeholder="Napr. Kvantová Fyzika"
                      />
                    </div>
                    <div className="space-y-1.5">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-1 gap-4 lg:w-80">
            <Card className="bg-white/50 dark:bg-black/20 backdrop-blur-sm border-primary/20">
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-muted-foreground">Celkový pokrok</p>
            ...
            <Card className="bg-white/50 dark:bg-black/20 backdrop-blur-sm border-secondary/20">
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-muted-foreground">Aktívne predmety</p>
                    <p className="text-2xl font-bold text-secondary">{stats.totalSubjects}</p>
                  </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {subjects.map((subject, index) => {
        ...
        return (
          <Card
            key={subject.id}
            className="group flex flex-col hover:shadow-xl transition-all duration-300 ease-in-out hover:scale-[1.02] border-muted/40 hover:border-primary/40"
            style={{
            ...
            <CardHeader className="pb-4">
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  ...
                  {subject.description && (
                    <CardDescription className="text-sm line-clamp-2 mt-2">{subject.description}</CardDescription>
                  )}
                </div>
                <Button
                  variant="ghost"
  ...
  const renderEmptyState = () => (
    <div className="text-center py-20 border-2 border-dashed border-border rounded-xl bg-muted/20">
      <div className="max-w-md mx-auto">
        ...
        <h2 className="text-2xl font-bold mb-3">Začni svoju študijnú cestu!</h2>
        <p className="text-muted-foreground mb-8 leading-relaxed">
          Zatiaľ nemáš pridané žiadne predmety. Pridaj svoj prvý predmet a začni organizovať svoje štúdium s pomocou AI.
        </p>
        <Dialog open={isAddSubjectDialogOpen} onOpenChange={setIsAddSubjectDialogOpen}>
          <DialogTrigger asChild>
            <Button size="lg" className="group">
